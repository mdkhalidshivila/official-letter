...
class Bill(models.Model):
    ...
    # salary = models.CharField(max_length=1000,null=True,blank=True,default="")
    #stipend = models.CharField(max_length=1000,null=True,blank=True,default="")
    stipend = models.CharField(max_length=1000,default=0)
